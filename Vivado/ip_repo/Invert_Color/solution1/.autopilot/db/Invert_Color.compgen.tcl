...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 1 \
			corename Invert_Color_control_axilite \
			name Invert_Color_control_s_axi \
			ports {$port_control} \
			op interface \
			is_flushable 0 \ 
			is_datawidth64 0 \ 
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler Invert_Color_control_s_axi
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { in_data_TVALID { I 1 bit } in_data_TREADY { O 1 bit } in_data_TLAST { I 1 vector } } \
} "
} else {
...
# RegSlice definition:
set ID 12
set RegSliceName Invert_Color_regslice_both
set RegSliceInstName Invert_Color_regslice_both_U
set CoreName ap_simcore_Invert_Color_regslice_both
if {${::AESL::PGuard_rtl_comp_handler}} {
