; ModuleID = 'C:/PYNQ/PYNQ-master/PYNQ-master/boards/ip/RGB2GRAY/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
%"struct.hls::axis.7" = type { %struct.ap_uint.8, %struct.ap_uint.3, %struct.ap_uint.3, %struct.ap_uint.3, %struct.ap_uint.3, %struct.ap_uint.3, %struct.ap_uint.3 }
%struct.ap_uint.8 = type { %struct.ap_int_base.9 }
%struct.ap_int_base.9 = type { %struct.ssdm_int.10 }
%struct.ssdm_int.10 = type { i8 }

; Function Attrs: noinline
define void @apatb_RGB2GRAY_ir(%"class.hls::stream"* %in_data, %"class.hls::stream.6"* %out_data) local_unnamed_addr #0 {
entry:
  %in_data_copy = alloca %"class.hls::stream", align 512
  %out_data_copy = alloca %"class.hls::stream.6", align 512
  call fastcc void @copy_in(%"class.hls::stream"* %in_data, %"class.hls::stream"* nonnull align 512 %in_data_copy, %"class.hls::stream.6"* %out_data, %"class.hls::stream.6"* nonnull align 512 %out_data_copy)
  call void @apatb_RGB2GRAY_hw(%"class.hls::stream"* %in_data_copy, %"class.hls::stream.6"* %out_data_copy)
  call fastcc void @copy_out(%"class.hls::stream"* %in_data, %"class.hls::stream"* nonnull align 512 %in_data_copy, %"class.hls::stream.6"* %out_data, %"class.hls::stream.6"* nonnull align 512 %out_data_copy)
  ret void
}

; Function Attrs: noinline
define internal fastcc void @copy_in(%"class.hls::stream"*, %"class.hls::stream"* noalias align 512, %"class.hls::stream.6"*, %"class.hls::stream.6"* noalias align 512) unnamed_addr #1 {
entry:
...
copy:                                             ; preds = %entry
  %5 = getelementptr %"class.hls::stream.6", %"class.hls::stream.6"* %1, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0
...
; <label>:17:                                     ; preds = %14
  %.01.0.0.0.09 = getelementptr %"class.hls::stream.6", %"class.hls::stream.6"* %0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0
...
; <label>:30:                                     ; preds = %26
  %.01.1.0.0.017.gep58 = getelementptr %"class.hls::stream.6", %"class.hls::stream.6"* %0, i32 0, i32 0, i32 1, i32 0, i32 0, i32 0
  %31 = bitcast i1* %.01.1.0.0.017.gep58 to i8*
  %.0.1.0.0.016.gep59 = getelementptr %"class.hls::stream.6", %"class.hls::stream.6"* %1, i32 0, i32 0, i32 1, i32 0, i32 0, i32 0
...
; <label>:45:                                     ; preds = %41
  %.01.2.0.0.025.gep60 = getelementptr %"class.hls::stream.6", %"class.hls::stream.6"* %0, i32 0, i32 0, i32 2, i32 0, i32 0, i32 0
  %46 = bitcast i1* %.01.2.0.0.025.gep60 to i8*
  %.0.2.0.0.024.gep61 = getelementptr %"class.hls::stream.6", %"class.hls::stream.6"* %1, i32 0, i32 0, i32 2, i32 0, i32 0, i32 0
...
; <label>:60:                                     ; preds = %56
  %.01.3.0.0.033.gep62 = getelementptr %"class.hls::stream.6", %"class.hls::stream.6"* %0, i32 0, i32 0, i32 3, i32 0, i32 0, i32 0
  %61 = bitcast i1* %.01.3.0.0.033.gep62 to i8*
  %.0.3.0.0.032.gep63 = getelementptr %"class.hls::stream.6", %"class.hls::stream.6"* %1, i32 0, i32 0, i32 3, i32 0, i32 0, i32 0
...
; <label>:75:                                     ; preds = %71
  %.01.4.0.0.041.gep64 = getelementptr %"class.hls::stream.6", %"class.hls::stream.6"* %0, i32 0, i32 0, i32 4, i32 0, i32 0, i32 0
  %76 = bitcast i1* %.01.4.0.0.041.gep64 to i8*
  %.0.4.0.0.040.gep65 = getelementptr %"class.hls::stream.6", %"class.hls::stream.6"* %1, i32 0, i32 0, i32 4, i32 0, i32 0, i32 0
...
; <label>:90:                                     ; preds = %86
  %.01.5.0.0.049.gep66 = getelementptr %"class.hls::stream.6", %"class.hls::stream.6"* %0, i32 0, i32 0, i32 5, i32 0, i32 0, i32 0
  %91 = bitcast i1* %.01.5.0.0.049.gep66 to i8*
  %.0.5.0.0.048.gep67 = getelementptr %"class.hls::stream.6", %"class.hls::stream.6"* %1, i32 0, i32 0, i32 5, i32 0, i32 0, i32 0
...
; <label>:105:                                    ; preds = %101
  %.01.6.0.0.057.gep68 = getelementptr %"class.hls::stream.6", %"class.hls::stream.6"* %0, i32 0, i32 0, i32 6, i32 0, i32 0, i32 0
  %106 = bitcast i1* %.01.6.0.0.057.gep68 to i8*
  %.0.6.0.0.056.gep69 = getelementptr %"class.hls::stream.6", %"class.hls::stream.6"* %1, i32 0, i32 0, i32 6, i32 0, i32 0, i32 0
...
ret:                                              ; preds = %empty
  %10 = getelementptr inbounds %"class.hls::stream.6", %"class.hls::stream.6"* %1, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0
  %11 = getelementptr inbounds %"class.hls::stream.6", %"class.hls::stream.6"* %0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0
...
ret:                                              ; preds = %empty
  %10 = getelementptr inbounds %struct.ap_uint.8, %struct.ap_uint.8* %1, i32 0, i32 0, i32 0, i32 0
  %11 = getelementptr inbounds %struct.ap_uint.8, %struct.ap_uint.8* %0, i32 0, i32 0, i32 0, i32 0
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %11, i8* align 1 %10, i64 1, i1 false)
  ret void
}
...
ret:                                              ; preds = %empty
  %10 = getelementptr inbounds %struct.ap_int_base.9, %struct.ap_int_base.9* %1, i32 0, i32 0, i32 0
  %11 = getelementptr inbounds %struct.ap_int_base.9, %struct.ap_int_base.9* %0, i32 0, i32 0, i32 0
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %11, i8* align 1 %10, i64 1, i1 false)
  ret void
}
...
ret:                                              ; preds = %empty
  %10 = getelementptr inbounds %struct.ssdm_int.10, %struct.ssdm_int.10* %1, i32 0, i32 0
  %11 = getelementptr inbounds %struct.ssdm_int.10, %struct.ssdm_int.10* %0, i32 0, i32 0
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %11, i8* align 1 %10, i64 1, i1 false)
  ret void
}

; Function Attrs: noinline
define internal fastcc void @copy_out(%"class.hls::stream"*, %"class.hls::stream"* noalias align 512, %"class.hls::stream.6"*, %"class.hls::stream.6"* noalias align 512) unnamed_addr #5 {
entry:
...
declare void @apatb_RGB2GRAY_hw(%"class.hls::stream"*, %"class.hls::stream.6"*)

define void @RGB2GRAY_hw_stub_wrapper(%"class.hls::stream"*, %"class.hls::stream.6"*) #6 {
entry:
  call void @copy_out(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream.6"* null, %"class.hls::stream.6"* %1)
  call void @RGB2GRAY_hw_stub(%"class.hls::stream"* %0, %"class.hls::stream.6"* %1)
  call void @copy_in(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream.6"* null, %"class.hls::stream.6"* %1)
  ret void
}

declare void @RGB2GRAY_hw_stub(%"class.hls::stream"*, %"class.hls::stream.6"*)
