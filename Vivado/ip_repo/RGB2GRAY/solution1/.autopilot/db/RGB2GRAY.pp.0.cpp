...
# 2 "RGB2GRAY/RGB2GRAY.cpp" 2
# 1 "C:/Xilinx/Vitis_HLS/2020.2/common/technology/autopilot\\ap_int.h" 1
# 3 "RGB2GRAY/RGB2GRAY.cpp" 2
...
# 5 "RGB2GRAY/RGB2GRAY.cpp" 2

__attribute__((sdx_kernel("RGB2GRAY", 0))) void RGB2GRAY(hls::stream<ap_axiu<24,1,1,1>> &in_data,hls::stream<ap_axiu<8,1,1,1>>& out_data){
#pragma HLS TOP name=RGB2GRAY
# 6 "RGB2GRAY/RGB2GRAY.cpp"
