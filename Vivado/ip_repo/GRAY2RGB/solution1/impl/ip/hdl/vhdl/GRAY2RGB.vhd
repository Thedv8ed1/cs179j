...
architecture behav of GRAY2RGB is 
    ...
    "GRAY2RGB_GRAY2RGB,hls_ip_2020_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=0.000000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=5,HLS_SYN_LUT=53,HLS_VERSION=2020_2}";
    ...
    signal gray_last_V_fu_122_p1 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    component GRAY2RGB_regslice_both IS
    generic (
        DataWidth : INTEGER );
    port (
        ap_clk : IN STD_LOGIC;
...
begin
    regslice_both_in_data_V_data_V_U : component GRAY2RGB_regslice_both
    generic map (
        DataWidth => 8)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_in_data_V_keep_V_U : component GRAY2RGB_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_in_data_V_strb_V_U : component GRAY2RGB_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_in_data_V_user_V_U : component GRAY2RGB_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_in_data_V_last_V_U : component GRAY2RGB_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_in_data_V_id_V_U : component GRAY2RGB_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_in_data_V_dest_V_U : component GRAY2RGB_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_out_data_V_data_V_U : component GRAY2RGB_regslice_both
    generic map (
        DataWidth => 24)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_out_data_V_keep_V_U : component GRAY2RGB_regslice_both
    generic map (
        DataWidth => 3)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_out_data_V_strb_V_U : component GRAY2RGB_regslice_both
    generic map (
        DataWidth => 3)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_out_data_V_user_V_U : component GRAY2RGB_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_out_data_V_last_V_U : component GRAY2RGB_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_out_data_V_id_V_U : component GRAY2RGB_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_out_data_V_dest_V_U : component GRAY2RGB_regslice_both
    generic map (
        DataWidth => 1)
    port map (
        ap_clk => ap_clk,
    ...
    ap_condition_pp0_flush_enable_assign_proc : process(ap_CS_fsm_pp0_stage0, gray_last_V_fu_122_p1, ap_block_pp0_stage0_subdone)
    begin
        if (((gray_last_V_fu_122_p1 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    gray_last_V_fu_122_p1 <= in_data_TLAST_int_regslice;
    ...
    out_data_TDATA_int_regslice <= ((in_data_TDATA_int_regslice & in_data_TDATA_int_regslice) & in_data_TDATA_int_regslice);
