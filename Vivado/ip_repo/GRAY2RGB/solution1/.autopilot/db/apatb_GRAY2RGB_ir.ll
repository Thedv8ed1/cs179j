; ModuleID = 'C:/PYNQ/PYNQ-master/PYNQ-master/boards/ip/GRAY2RGB/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

%"class.hls::stream" = type { %"struct.hls::axis" }
%"struct.hls::axis" = type { %struct.ap_uint, %struct.ap_uint.0, %struct.ap_uint.0, %struct.ap_uint.0, %struct.ap_uint.0, %struct.ap_uint.0, %struct.ap_uint.0 }
...
%"struct.hls::axis.4" = type { %struct.ap_uint.5, %struct.ap_uint.8, %struct.ap_uint.8, %struct.ap_uint.0, %struct.ap_uint.0, %struct.ap_uint.0, %struct.ap_uint.0 }
%struct.ap_uint.5 = type { %struct.ap_int_base.6 }
%struct.ap_int_base.6 = type { %struct.ssdm_int.7 }
%struct.ssdm_int.7 = type { i24 }
%struct.ap_uint.8 = type { %struct.ap_int_base.9 }
%struct.ap_int_base.9 = type { %struct.ssdm_int.10 }
%struct.ssdm_int.10 = type { i3 }

; Function Attrs: noinline
define void @apatb_GRAY2RGB_ir(%"class.hls::stream"* %in_data, %"class.hls::stream.3"* %out_data) local_unnamed_addr #0 {
entry:
  %in_data_copy = alloca %"class.hls::stream", align 512
  %out_data_copy = alloca %"class.hls::stream.3", align 512
  call fastcc void @copy_in(%"class.hls::stream"* %in_data, %"class.hls::stream"* nonnull align 512 %in_data_copy, %"class.hls::stream.3"* %out_data, %"class.hls::stream.3"* nonnull align 512 %out_data_copy)
  call void @apatb_GRAY2RGB_hw(%"class.hls::stream"* %in_data_copy, %"class.hls::stream.3"* %out_data_copy)
  call fastcc void @copy_out(%"class.hls::stream"* %in_data, %"class.hls::stream"* nonnull align 512 %in_data_copy, %"class.hls::stream.3"* %out_data, %"class.hls::stream.3"* nonnull align 512 %out_data_copy)
  ret void
}

; Function Attrs: noinline
define internal fastcc void @copy_in(%"class.hls::stream"*, %"class.hls::stream"* noalias align 512, %"class.hls::stream.3"*, %"class.hls::stream.3"* noalias align 512) unnamed_addr #1 {
entry:
...
; <label>:18:                                     ; preds = %17, %16, %13, %10
  ...
  %19 = bitcast %struct.ap_uint.0* %.0.110 to i8*
...
; <label>:22:                                     ; preds = %18
  ...
  %23 = bitcast %struct.ap_int_base.1* %.0.1.012 to i8*
...
; <label>:26:                                     ; preds = %22
  ...
  %27 = bitcast %struct.ssdm_int.2* %.0.1.0.014 to i8*
...
; <label>:33:                                     ; preds = %30, %29, %25, %21
  ...
  %34 = bitcast %struct.ap_uint.0* %.0.218 to i8*
...
; <label>:37:                                     ; preds = %33
  ...
  %38 = bitcast %struct.ap_int_base.1* %.0.2.020 to i8*
...
; <label>:41:                                     ; preds = %37
  ...
  %42 = bitcast %struct.ssdm_int.2* %.0.2.0.022 to i8*
...
; <label>:48:                                     ; preds = %45, %44, %40, %36
  ...
  %49 = bitcast %struct.ap_uint.0* %.0.326 to i8*
...
; <label>:52:                                     ; preds = %48
  ...
  %53 = bitcast %struct.ap_int_base.1* %.0.3.028 to i8*
...
; <label>:56:                                     ; preds = %52
  ...
  %57 = bitcast %struct.ssdm_int.2* %.0.3.0.030 to i8*
...
; <label>:63:                                     ; preds = %60, %59, %55, %51
  ...
  %64 = bitcast %struct.ap_uint.0* %.0.434 to i8*
...
; <label>:67:                                     ; preds = %63
  ...
  %68 = bitcast %struct.ap_int_base.1* %.0.4.036 to i8*
...
; <label>:71:                                     ; preds = %67
  ...
  %72 = bitcast %struct.ssdm_int.2* %.0.4.0.038 to i8*
...
; <label>:78:                                     ; preds = %75, %74, %70, %66
  ...
  %79 = bitcast %struct.ap_uint.0* %.0.542 to i8*
...
; <label>:82:                                     ; preds = %78
  ...
  %83 = bitcast %struct.ap_int_base.1* %.0.5.044 to i8*
...
; <label>:86:                                     ; preds = %82
  ...
  %87 = bitcast %struct.ssdm_int.2* %.0.5.0.046 to i8*
...
; <label>:93:                                     ; preds = %90, %89, %85, %81
  ...
  %94 = bitcast %struct.ap_uint.0* %.0.650 to i8*
...
; <label>:97:                                     ; preds = %93
  ...
  %98 = bitcast %struct.ap_int_base.1* %.0.6.052 to i8*
...
; <label>:101:                                    ; preds = %97
  ...
  %102 = bitcast %struct.ssdm_int.2* %.0.6.0.054 to i8*
...
; <label>:10:                                     ; preds = %8
  call fastcc void @streamcpy_hls.p0struct.ap_uint.5(%struct.ap_uint.5* align 512 %.01.03, %struct.ap_uint.5* %.0.02)
  br label %19
...
; <label>:13:                                     ; preds = %11
  call fastcc void @streamcpy_hls.p0struct.ap_int_base.6(%struct.ap_int_base.6* align 512 %.01.0.05, %struct.ap_int_base.6* %.0.0.04)
  br label %19
...
; <label>:16:                                     ; preds = %14
  call fastcc void @streamcpy_hls.p0struct.ssdm_int.7(%struct.ssdm_int.7* align 512 %.01.0.0.07, %struct.ssdm_int.7* %.0.0.0.06)
  br label %19
...
; <label>:31:                                     ; preds = %27
  %.01.1.0.0.017.gep59 = getelementptr %"class.hls::stream.3", %"class.hls::stream.3"* %0, i32 0, i32 0, i32 1, i32 0, i32 0, i32 0
  %32 = bitcast i3* %.01.1.0.0.017.gep59 to i8*
  %.0.1.0.0.016.gep60 = getelementptr %"class.hls::stream.3", %"class.hls::stream.3"* %1, i32 0, i32 0, i32 1, i32 0, i32 0, i32 0
...
; <label>:34:                                     ; preds = %31, %30, %26, %22
  %.0.218 = getelementptr %"class.hls::stream.3", %"class.hls::stream.3"* %1, i32 0, i32 0, i32 2
  %.01.219 = getelementptr %"class.hls::stream.3", %"class.hls::stream.3"* %0, i32 0, i32 0, i32 2
...
; <label>:38:                                     ; preds = %34
  %.0.2.020 = getelementptr %"class.hls::stream.3", %"class.hls::stream.3"* %1, i32 0, i32 0, i32 2, i32 0
  %.01.2.021 = getelementptr %"class.hls::stream.3", %"class.hls::stream.3"* %0, i32 0, i32 0, i32 2, i32 0
...
; <label>:42:                                     ; preds = %38
  %.0.2.0.022 = getelementptr %"class.hls::stream.3", %"class.hls::stream.3"* %1, i32 0, i32 0, i32 2, i32 0, i32 0
  %.01.2.0.023 = getelementptr %"class.hls::stream.3", %"class.hls::stream.3"* %0, i32 0, i32 0, i32 2, i32 0, i32 0
...
; <label>:46:                                     ; preds = %42
  %.01.2.0.0.025.gep61 = getelementptr %"class.hls::stream.3", %"class.hls::stream.3"* %0, i32 0, i32 0, i32 2, i32 0, i32 0, i32 0
  %47 = bitcast i3* %.01.2.0.0.025.gep61 to i8*
  %.0.2.0.0.024.gep62 = getelementptr %"class.hls::stream.3", %"class.hls::stream.3"* %1, i32 0, i32 0, i32 2, i32 0, i32 0, i32 0
...
; <label>:49:                                     ; preds = %46, %45, %41, %37
  %.0.326 = getelementptr %"class.hls::stream.3", %"class.hls::stream.3"* %1, i32 0, i32 0, i32 3
  %.01.327 = getelementptr %"class.hls::stream.3", %"class.hls::stream.3"* %0, i32 0, i32 0, i32 3
...
; <label>:53:                                     ; preds = %49
  %.0.3.028 = getelementptr %"class.hls::stream.3", %"class.hls::stream.3"* %1, i32 0, i32 0, i32 3, i32 0
  %.01.3.029 = getelementptr %"class.hls::stream.3", %"class.hls::stream.3"* %0, i32 0, i32 0, i32 3, i32 0
...
; <label>:57:                                     ; preds = %53
  %.0.3.0.030 = getelementptr %"class.hls::stream.3", %"class.hls::stream.3"* %1, i32 0, i32 0, i32 3, i32 0, i32 0
  %.01.3.0.031 = getelementptr %"class.hls::stream.3", %"class.hls::stream.3"* %0, i32 0, i32 0, i32 3, i32 0, i32 0
...
; <label>:61:                                     ; preds = %57
  %.01.3.0.0.033.gep63 = getelementptr %"class.hls::stream.3", %"class.hls::stream.3"* %0, i32 0, i32 0, i32 3, i32 0, i32 0, i32 0
  %62 = bitcast i1* %.01.3.0.0.033.gep63 to i8*
  %.0.3.0.0.032.gep64 = getelementptr %"class.hls::stream.3", %"class.hls::stream.3"* %1, i32 0, i32 0, i32 3, i32 0, i32 0, i32 0
...
; <label>:64:                                     ; preds = %61, %60, %56, %52
  %.0.434 = getelementptr %"class.hls::stream.3", %"class.hls::stream.3"* %1, i32 0, i32 0, i32 4
  %.01.435 = getelementptr %"class.hls::stream.3", %"class.hls::stream.3"* %0, i32 0, i32 0, i32 4
  %65 = bitcast %struct.ap_uint.0* %.0.434 to i8*
...
; <label>:68:                                     ; preds = %64
  %.0.4.036 = getelementptr %"class.hls::stream.3", %"class.hls::stream.3"* %1, i32 0, i32 0, i32 4, i32 0
  %.01.4.037 = getelementptr %"class.hls::stream.3", %"class.hls::stream.3"* %0, i32 0, i32 0, i32 4, i32 0
  %69 = bitcast %struct.ap_int_base.1* %.0.4.036 to i8*
...
; <label>:72:                                     ; preds = %68
  %.0.4.0.038 = getelementptr %"class.hls::stream.3", %"class.hls::stream.3"* %1, i32 0, i32 0, i32 4, i32 0, i32 0
  %.01.4.0.039 = getelementptr %"class.hls::stream.3", %"class.hls::stream.3"* %0, i32 0, i32 0, i32 4, i32 0, i32 0
  %73 = bitcast %struct.ssdm_int.2* %.0.4.0.038 to i8*
...
; <label>:76:                                     ; preds = %72
  %.01.4.0.0.041.gep65 = getelementptr %"class.hls::stream.3", %"class.hls::stream.3"* %0, i32 0, i32 0, i32 4, i32 0, i32 0, i32 0
  %77 = bitcast i1* %.01.4.0.0.041.gep65 to i8*
  %.0.4.0.0.040.gep66 = getelementptr %"class.hls::stream.3", %"class.hls::stream.3"* %1, i32 0, i32 0, i32 4, i32 0, i32 0, i32 0
...
; <label>:79:                                     ; preds = %76, %75, %71, %67
  %.0.542 = getelementptr %"class.hls::stream.3", %"class.hls::stream.3"* %1, i32 0, i32 0, i32 5
  %.01.543 = getelementptr %"class.hls::stream.3", %"class.hls::stream.3"* %0, i32 0, i32 0, i32 5
  %80 = bitcast %struct.ap_uint.0* %.0.542 to i8*
...
; <label>:83:                                     ; preds = %79
  %.0.5.044 = getelementptr %"class.hls::stream.3", %"class.hls::stream.3"* %1, i32 0, i32 0, i32 5, i32 0
  %.01.5.045 = getelementptr %"class.hls::stream.3", %"class.hls::stream.3"* %0, i32 0, i32 0, i32 5, i32 0
  %84 = bitcast %struct.ap_int_base.1* %.0.5.044 to i8*
...
; <label>:87:                                     ; preds = %83
  %.0.5.0.046 = getelementptr %"class.hls::stream.3", %"class.hls::stream.3"* %1, i32 0, i32 0, i32 5, i32 0, i32 0
  %.01.5.0.047 = getelementptr %"class.hls::stream.3", %"class.hls::stream.3"* %0, i32 0, i32 0, i32 5, i32 0, i32 0
  %88 = bitcast %struct.ssdm_int.2* %.0.5.0.046 to i8*
...
; <label>:91:                                     ; preds = %87
  %.01.5.0.0.049.gep67 = getelementptr %"class.hls::stream.3", %"class.hls::stream.3"* %0, i32 0, i32 0, i32 5, i32 0, i32 0, i32 0
  %92 = bitcast i1* %.01.5.0.0.049.gep67 to i8*
  %.0.5.0.0.048.gep68 = getelementptr %"class.hls::stream.3", %"class.hls::stream.3"* %1, i32 0, i32 0, i32 5, i32 0, i32 0, i32 0
...
; <label>:94:                                     ; preds = %91, %90, %86, %82
  %.0.650 = getelementptr %"class.hls::stream.3", %"class.hls::stream.3"* %1, i32 0, i32 0, i32 6
  %.01.651 = getelementptr %"class.hls::stream.3", %"class.hls::stream.3"* %0, i32 0, i32 0, i32 6
  %95 = bitcast %struct.ap_uint.0* %.0.650 to i8*
...
; <label>:98:                                     ; preds = %94
  %.0.6.052 = getelementptr %"class.hls::stream.3", %"class.hls::stream.3"* %1, i32 0, i32 0, i32 6, i32 0
  %.01.6.053 = getelementptr %"class.hls::stream.3", %"class.hls::stream.3"* %0, i32 0, i32 0, i32 6, i32 0
  %99 = bitcast %struct.ap_int_base.1* %.0.6.052 to i8*
...
; <label>:102:                                    ; preds = %98
  %.0.6.0.054 = getelementptr %"class.hls::stream.3", %"class.hls::stream.3"* %1, i32 0, i32 0, i32 6, i32 0, i32 0
  %.01.6.0.055 = getelementptr %"class.hls::stream.3", %"class.hls::stream.3"* %0, i32 0, i32 0, i32 6, i32 0, i32 0
  %103 = bitcast %struct.ssdm_int.2* %.0.6.0.054 to i8*
...
; <label>:106:                                    ; preds = %102
  %.01.6.0.0.057.gep69 = getelementptr %"class.hls::stream.3", %"class.hls::stream.3"* %0, i32 0, i32 0, i32 6, i32 0, i32 0, i32 0
  %107 = bitcast i1* %.01.6.0.0.057.gep69 to i8*
  %.0.6.0.0.056.gep70 = getelementptr %"class.hls::stream.3", %"class.hls::stream.3"* %1, i32 0, i32 0, i32 6, i32 0, i32 0, i32 0
...
; Function Attrs: argmemonly noinline
define internal fastcc void @streamcpy_hls.p0struct.ap_uint.5(%struct.ap_uint.5* noalias nocapture align 512, %struct.ap_uint.5* noalias nocapture) unnamed_addr #3 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @streamcpy_hls.p0struct.ap_int_base.6(%struct.ap_int_base.6* noalias nocapture align 512, %struct.ap_int_base.6* noalias nocapture) unnamed_addr #3 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @streamcpy_hls.p0struct.ssdm_int.7(%struct.ssdm_int.7* noalias nocapture align 512, %struct.ssdm_int.7* noalias nocapture) unnamed_addr #3 {
entry:
...
; Function Attrs: noinline
define internal fastcc void @copy_out(%"class.hls::stream"*, %"class.hls::stream"* noalias align 512, %"class.hls::stream.3"*, %"class.hls::stream.3"* noalias align 512) unnamed_addr #5 {
entry:
...
declare void @apatb_GRAY2RGB_hw(%"class.hls::stream"*, %"class.hls::stream.3"*)

define void @GRAY2RGB_hw_stub_wrapper(%"class.hls::stream"*, %"class.hls::stream.3"*) #6 {
entry:
  call void @copy_out(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream.3"* null, %"class.hls::stream.3"* %1)
  call void @GRAY2RGB_hw_stub(%"class.hls::stream"* %0, %"class.hls::stream.3"* %1)
  call void @copy_in(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream.3"* null, %"class.hls::stream.3"* %1)
  ret void
}

declare void @GRAY2RGB_hw_stub(%"class.hls::stream"*, %"class.hls::stream.3"*)
