...
# 2 "GRAY2RGB/GRAY2RGB.cpp" 2
# 1 "C:/Xilinx/Vitis_HLS/2020.2/common/technology/autopilot\\ap_int.h" 1
# 3 "GRAY2RGB/GRAY2RGB.cpp" 2
...
# 5 "GRAY2RGB/GRAY2RGB.cpp" 2

__attribute__((sdx_kernel("GRAY2RGB", 0))) void GRAY2RGB(hls::stream<ap_axiu<8,1,1,1>> &in_data,hls::stream<ap_axiu<24,1,1,1>>& out_data){
#pragma HLS TOP name=GRAY2RGB
# 6 "GRAY2RGB/GRAY2RGB.cpp"
...
VITIS_LOOP_13_1: while(!gray.last){
 gray=in_data.read();
