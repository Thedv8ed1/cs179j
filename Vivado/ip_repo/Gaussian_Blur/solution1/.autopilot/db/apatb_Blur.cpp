...
#define AUTOTB_TVOUT_in_data_V_data_V "../tv/cdatafile/c.Blur.autotvout_in_data_V_data_V.dat"
#define AUTOTB_TVIN_in_data_V_keep_V "../tv/cdatafile/c.Blur.autotvin_in_data_V_keep_V.dat"
#define AUTOTB_TVOUT_in_data_V_keep_V "../tv/cdatafile/c.Blur.autotvout_in_data_V_keep_V.dat"
#define AUTOTB_TVIN_in_data_V_strb_V "../tv/cdatafile/c.Blur.autotvin_in_data_V_strb_V.dat"
#define AUTOTB_TVOUT_in_data_V_strb_V "../tv/cdatafile/c.Blur.autotvout_in_data_V_strb_V.dat"
#define AUTOTB_TVIN_in_data_V_user_V "../tv/cdatafile/c.Blur.autotvin_in_data_V_user_V.dat"
#define AUTOTB_TVOUT_in_data_V_user_V "../tv/cdatafile/c.Blur.autotvout_in_data_V_user_V.dat"
#define AUTOTB_TVIN_in_data_V_last_V "../tv/cdatafile/c.Blur.autotvin_in_data_V_last_V.dat"
#define AUTOTB_TVOUT_in_data_V_last_V "../tv/cdatafile/c.Blur.autotvout_in_data_V_last_V.dat"
#define AUTOTB_TVIN_in_data_V_id_V "../tv/cdatafile/c.Blur.autotvin_in_data_V_id_V.dat"
#define AUTOTB_TVOUT_in_data_V_id_V "../tv/cdatafile/c.Blur.autotvout_in_data_V_id_V.dat"
#define AUTOTB_TVIN_in_data_V_dest_V "../tv/cdatafile/c.Blur.autotvin_in_data_V_dest_V.dat"
#define AUTOTB_TVOUT_in_data_V_dest_V "../tv/cdatafile/c.Blur.autotvout_in_data_V_dest_V.dat"
...
#define AUTOTB_TVIN_out_data_V_user_V "../tv/cdatafile/c.Blur.autotvin_out_data_V_user_V.dat"
#define AUTOTB_TVOUT_out_data_V_user_V "../tv/cdatafile/c.Blur.autotvout_out_data_V_user_V.dat"
...
#define AUTOTB_TVIN_out_data_V_id_V "../tv/cdatafile/c.Blur.autotvin_out_data_V_id_V.dat"
#define AUTOTB_TVOUT_out_data_V_id_V "../tv/cdatafile/c.Blur.autotvout_out_data_V_id_V.dat"
#define AUTOTB_TVIN_out_data_V_dest_V "../tv/cdatafile/c.Blur.autotvin_out_data_V_dest_V.dat"
#define AUTOTB_TVOUT_out_data_V_dest_V "../tv/cdatafile/c.Blur.autotvout_out_data_V_dest_V.dat"
...
#define AUTOTB_TVOUT_w "../tv/cdatafile/c.Blur.autotvout_w.dat"
// wrapc file define:
#define AUTOTB_TVIN_h "../tv/cdatafile/c.Blur.autotvin_h.dat"
#define AUTOTB_TVOUT_h "../tv/cdatafile/c.Blur.autotvout_h.dat"

#define INTER_TCL "../tv/cdatafile/ref.tcl"

// tvout file define:
#define AUTOTB_TVOUT_PC_in_data_V_data_V "../tv/rtldatafile/rtl.Blur.autotvout_in_data_V_data_V.dat"
#define AUTOTB_TVOUT_PC_in_data_V_keep_V "../tv/rtldatafile/rtl.Blur.autotvout_in_data_V_keep_V.dat"
#define AUTOTB_TVOUT_PC_in_data_V_strb_V "../tv/rtldatafile/rtl.Blur.autotvout_in_data_V_strb_V.dat"
#define AUTOTB_TVOUT_PC_in_data_V_user_V "../tv/rtldatafile/rtl.Blur.autotvout_in_data_V_user_V.dat"
#define AUTOTB_TVOUT_PC_in_data_V_last_V "../tv/rtldatafile/rtl.Blur.autotvout_in_data_V_last_V.dat"
#define AUTOTB_TVOUT_PC_in_data_V_id_V "../tv/rtldatafile/rtl.Blur.autotvout_in_data_V_id_V.dat"
#define AUTOTB_TVOUT_PC_in_data_V_dest_V "../tv/rtldatafile/rtl.Blur.autotvout_in_data_V_dest_V.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_out_data_V_data_V "../tv/rtldatafile/rtl.Blur.autotvout_out_data_V_data_V.dat"
#define AUTOTB_TVOUT_PC_out_data_V_keep_V "../tv/rtldatafile/rtl.Blur.autotvout_out_data_V_keep_V.dat"
#define AUTOTB_TVOUT_PC_out_data_V_strb_V "../tv/rtldatafile/rtl.Blur.autotvout_out_data_V_strb_V.dat"
#define AUTOTB_TVOUT_PC_out_data_V_user_V "../tv/rtldatafile/rtl.Blur.autotvout_out_data_V_user_V.dat"
#define AUTOTB_TVOUT_PC_out_data_V_last_V "../tv/rtldatafile/rtl.Blur.autotvout_out_data_V_last_V.dat"
#define AUTOTB_TVOUT_PC_out_data_V_id_V "../tv/rtldatafile/rtl.Blur.autotvout_out_data_V_id_V.dat"
#define AUTOTB_TVOUT_PC_out_data_V_dest_V "../tv/rtldatafile/rtl.Blur.autotvout_out_data_V_dest_V.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_w "../tv/rtldatafile/rtl.Blur.autotvout_w.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_h "../tv/rtldatafile/rtl.Blur.autotvout_h.dat"
...
extern "C" void Blur_hw_stub_wrapper(volatile void *, volatile void *, int, int);

extern "C" void apatb_Blur_hw(volatile void * __xlx_apatb_param_in_data, volatile void * __xlx_apatb_param_out_data, int __xlx_apatb_param_w, int __xlx_apatb_param_h) {
    ...
    string AESL_num;long __xlx_apatb_param_in_data_stream_buf_final_size;
{
  ...
  for (long i = 0; i < __xlx_apatb_param_in_data_stream_buf_final_size; ++i)((hls::stream<__cosim_sC__>*)__xlx_apatb_param_in_data)->read();
{sc_bv<96> xlx_stream_out_data_pc_buffer;
unsigned xlx_stream_out_data_size = 0;

          std::vector<sc_bv<24> > out_data_V_data_V_pc_buffer_Copy;
{
      static ifstream rtl_tv_out_file;
      if (!rtl_tv_out_file.is_open()) {
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<24> > out_data_V_data_V_pc_buffer;
          int i = 0;
...
out_data_V_data_V_pc_buffer_Copy=out_data_V_data_V_pc_buffer;
          ...
          std::vector<sc_bv<24> > out_data_V_keep_V_pc_buffer_Copy;
{
      static ifstream rtl_tv_out_file;
      if (!rtl_tv_out_file.is_open()) {
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<24> > out_data_V_keep_V_pc_buffer;
          int i = 0;
...
out_data_V_keep_V_pc_buffer_Copy=out_data_V_keep_V_pc_buffer;
          ...
          std::vector<sc_bv<24> > out_data_V_strb_V_pc_buffer_Copy;
{
      static ifstream rtl_tv_out_file;
      if (!rtl_tv_out_file.is_open()) {
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<24> > out_data_V_strb_V_pc_buffer;
          int i = 0;
...
out_data_V_strb_V_pc_buffer_Copy=out_data_V_strb_V_pc_buffer;
          ...
          std::vector<sc_bv<24> > out_data_V_user_V_pc_buffer_Copy;
{
      static ifstream rtl_tv_out_file;
      if (!rtl_tv_out_file.is_open()) {
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<24> > out_data_V_user_V_pc_buffer;
          int i = 0;
...
out_data_V_user_V_pc_buffer_Copy=out_data_V_user_V_pc_buffer;
          ...
          std::vector<sc_bv<24> > out_data_V_last_V_pc_buffer_Copy;
{
      static ifstream rtl_tv_out_file;
      if (!rtl_tv_out_file.is_open()) {
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<24> > out_data_V_last_V_pc_buffer;
          int i = 0;
...
out_data_V_last_V_pc_buffer_Copy=out_data_V_last_V_pc_buffer;
          ...
          std::vector<sc_bv<24> > out_data_V_id_V_pc_buffer_Copy;
{
      static ifstream rtl_tv_out_file;
      if (!rtl_tv_out_file.is_open()) {
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<24> > out_data_V_id_V_pc_buffer;
          int i = 0;
...
out_data_V_id_V_pc_buffer_Copy=out_data_V_id_V_pc_buffer;
          ...
          std::vector<sc_bv<24> > out_data_V_dest_V_pc_buffer_Copy;
{
      static ifstream rtl_tv_out_file;
      if (!rtl_tv_out_file.is_open()) {
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<24> > out_data_V_dest_V_pc_buffer;
          int i = 0;
...
xlx_stream_out_data_pc_buffer.range(31, 0) = out_data_V_data_V_pc_buffer_Copy[j];
xlx_stream_out_data_pc_buffer.range(39, 32) = out_data_V_keep_V_pc_buffer_Copy[j];
xlx_stream_out_data_pc_buffer.range(47, 40) = out_data_V_strb_V_pc_buffer_Copy[j];
xlx_stream_out_data_pc_buffer.range(55, 48) = out_data_V_user_V_pc_buffer_Copy[j];
xlx_stream_out_data_pc_buffer.range(63, 56) = out_data_V_last_V_pc_buffer_Copy[j];
xlx_stream_out_data_pc_buffer.range(71, 64) = out_data_V_id_V_pc_buffer_Copy[j];
xlx_stream_out_data_pc_buffer.range(95, 72) = out_data_V_dest_V_pc_buffer_Copy[j];
__cosim_sC__ xlx_stream_elt;
((long long*)&xlx_stream_elt)[0*1+0] = xlx_stream_out_data_pc_buffer.range(63,0).to_int64();
((long long*)&xlx_stream_elt)[0*1+1] = xlx_stream_out_data_pc_buffer.range(95,64).to_int64();
((hls::stream<__cosim_sC__>*)__xlx_apatb_param_out_data)->write(xlx_stream_elt);
}}
    AESL_transaction_pc++;
    return ;
  }
...
{
  while (!((hls::stream<__cosim_sC__>*)__xlx_apatb_param_in_data)->empty())
    __xlx_apatb_param_in_data_stream_buf.push_back(((hls::stream<__cosim_sC__>*)__xlx_apatb_param_in_data)->read());
  for (int i = 0; i < __xlx_apatb_param_in_data_stream_buf.size(); ++i)
    ((hls::stream<__cosim_sC__>*)__xlx_apatb_param_in_data)->write(__xlx_apatb_param_in_data_stream_buf[i]);
  }
...
Blur_hw_stub_wrapper(__xlx_apatb_param_in_data, __xlx_apatb_param_out_data, __xlx_apatb_param_w, __xlx_apatb_param_h);
...
__xlx_tmp_lv.range(63,0) = ((long long*)&__xlx_apatb_param_in_data_stream_buf[j])[0*1+0];
__xlx_tmp_lv.range(95,64) = ((long long*)&__xlx_apatb_param_in_data_stream_buf[j])[0*1+1];
...
long __xlx_apatb_param_out_data_stream_buf_final_size = ((hls::stream<__cosim_sC__>*)__xlx_apatb_param_out_data)->size() - __xlx_apatb_param_out_data_stream_buf_size;
{
  while (!((hls::stream<__cosim_sC__>*)__xlx_apatb_param_out_data)->empty())
    __xlx_apatb_param_out_data_stream_buf.push_back(((hls::stream<__cosim_sC__>*)__xlx_apatb_param_out_data)->read());
  for (int i = 0; i < __xlx_apatb_param_out_data_stream_buf.size(); ++i)
    ((hls::stream<__cosim_sC__>*)__xlx_apatb_param_out_data)->write(__xlx_apatb_param_out_data_stream_buf[i]);
  }
...
sc_bv<96> __xlx_tmp_lv;
__xlx_tmp_lv.range(63,0) = ((long long*)&__xlx_apatb_param_out_data_stream_buf[__xlx_apatb_param_out_data_stream_buf_size+j])[0*1+0];
__xlx_tmp_lv.range(95,64) = ((long long*)&__xlx_apatb_param_out_data_stream_buf[__xlx_apatb_param_out_data_stream_buf_size+j])[0*1+1];
sc_bv<24> __xlx_tmp_0_lv = __xlx_tmp_lv.range(23, 0);
sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_0_lv.to_string(SC_HEX).c_str());
aesl_fh.write(AUTOTB_TVOUT_out_data_V_data_V, __xlx_sprintf_buffer.data());
sc_bv<8> __xlx_tmp_1_lv = __xlx_tmp_lv.range(39, 32);
