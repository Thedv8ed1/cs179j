...
set id 10
set name Blur_dmul_64ns_64ns_64_7_max_dsp_1
...
set id 13
set name Blur_uitodp_32ns_64_6_no_dsp_1
...
set id 16
set name Blur_mul_32ns_32ns_64_2_1
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_hconv \
    op interface \
    ports { hconv_din { O 24 vector } hconv_full_n { I 1 bit } hconv_write { O 1 bit } } \
} "
}
...
# RegSlice definition:
set ID 30
set RegSliceName Blur_regslice_both
set RegSliceInstName Blur_regslice_both_U
set CoreName ap_simcore_Blur_regslice_both
if {${::AESL::PGuard_rtl_comp_handler}} {
