...
# 2 "Gaussian_Blur/blur.cpp" 2
# 1 "C:/Xilinx/Vitis_HLS/2020.2/common/technology/autopilot\\ap_int.h" 1
# 3 "Gaussian_Blur/blur.cpp" 2
...
#pragma HLS INLINE
 ...
 (void) ((!!(height<1080)) || (_assert("height<MAX_IMG_ROWS","Gaussian_Blur/blur.cpp",39),0));
    (void) ((!!(width<1920)) || (_assert("width<MAX_IMG_COLS","Gaussian_Blur/blur.cpp",40),0));
    (void) ((!!(vconv_xlim<1920 -(K-1))) || (_assert("vconv_xlim<MAX_IMG_COLS-(K-1)","Gaussian_Blur/blur.cpp",41),0));
...
#pragma HLS PIPELINE
 T in_val=hconv.read();
    ...
    Border:for(int i=0;i<height;i++){
        VITIS_LOOP_87_1: for(int j=0;j<width;j++){
...
__attribute__((sdx_kernel("Blur", 0))) void Blur(video_stream &in_data,video_stream& out_data,
  int w, int h) {
#pragma HLS TOP name=Blur
# 119 "Gaussian_Blur/blur.cpp"
...
#pragma HLS DATAFLOW
#pragma HLS INLINE
 convolution_strm<ap_uint<24>,15>(w,h,in_data,out_data);
