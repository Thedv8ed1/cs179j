set moduleName Block_split549_proc
set isTopModule 0
...
set C_modelName {Block_.split549_proc}
...
set portList { 
	...
	{ w_dout sc_in sc_lv 32 signal 0 } 
	{ w_empty_n sc_in sc_logic 1 signal 0 } 
	{ w_read sc_out sc_logic 1 signal 0 } 
	{ w_out_din sc_out sc_lv 32 signal 1 } 
	{ w_out_full_n sc_in sc_logic 1 signal 1 } 
	{ w_out_write sc_out sc_logic 1 signal 1 } 
	{ vconv_xlim_out_out_din sc_out sc_lv 32 signal 2 } 
	{ vconv_xlim_out_out_full_n sc_in sc_logic 1 signal 2 } 
	{ vconv_xlim_out_out_write sc_out sc_logic 1 signal 2 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "w_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "3", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "w_out_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "vconv_xlim_out_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
