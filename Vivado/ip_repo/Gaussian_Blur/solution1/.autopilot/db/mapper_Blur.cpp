...
extern "C" void Blur(__cosim_sC__*, __cosim_sC__*, int, int);
extern "C" void apatb_Blur_hw(volatile void * __xlx_apatb_param_in_data, volatile void * __xlx_apatb_param_out_data, int __xlx_apatb_param_w, int __xlx_apatb_param_h) {
  ...
  // DUT call
  Blur(__xlx_in_data_input_buffer, __xlx_out_data_input_buffer, __xlx_apatb_param_w, __xlx_apatb_param_h);
