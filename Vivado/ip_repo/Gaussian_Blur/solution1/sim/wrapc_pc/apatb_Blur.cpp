...
// wrapc file define:
#define AUTOTB_TVIN_sigma "../tv/cdatafile/c.Blur.autotvin_sigma.dat"
#define AUTOTB_TVOUT_sigma "../tv/cdatafile/c.Blur.autotvout_sigma.dat"
// wrapc file define:
#define AUTOTB_TVIN_kernal "../tv/cdatafile/c.Blur.autotvin_kernal.dat"
#define AUTOTB_TVOUT_kernal "../tv/cdatafile/c.Blur.autotvout_kernal.dat"
...
// tvout file define:
#define AUTOTB_TVOUT_PC_sigma "../tv/rtldatafile/rtl.Blur.autotvout_sigma.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_kernal "../tv/rtldatafile/rtl.Blur.autotvout_kernal.dat"
...
string get_depth_list () {
  ...
  total_list << "{sigma " << sigma_depth << "}\n";
  total_list << "{kernal " << kernal_depth << "}\n";
...
extern "C" void Blur_hw_stub_wrapper(volatile void *, volatile void *, int, int, double, int);

extern "C" void apatb_Blur_hw(volatile void * __xlx_apatb_param_in_data, volatile void * __xlx_apatb_param_out_data, int __xlx_apatb_param_w, int __xlx_apatb_param_h, double __xlx_apatb_param_sigma, int __xlx_apatb_param_kernal) {
...
//sigma
aesl_fh.touch(AUTOTB_TVIN_sigma);
aesl_fh.touch(AUTOTB_TVOUT_sigma);
//kernal
aesl_fh.touch(AUTOTB_TVIN_kernal);
aesl_fh.touch(AUTOTB_TVOUT_kernal);
...
// print sigma Transactions
{
  sprintf(__xlx_sprintf_buffer.data(), "[[transaction]] %d\n", AESL_transaction);
  aesl_fh.write(AUTOTB_TVIN_sigma, __xlx_sprintf_buffer.data());
  {
    sc_bv<64> __xlx_tmp_lv = *((long long*)&__xlx_apatb_param_sigma);

    sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_lv.to_string(SC_HEX).c_str());
    aesl_fh.write(AUTOTB_TVIN_sigma, __xlx_sprintf_buffer.data()); 
  }
  tcl_file.set_num(1, &tcl_file.sigma_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_sigma, __xlx_sprintf_buffer.data());
}
// print kernal Transactions
{
  sprintf(__xlx_sprintf_buffer.data(), "[[transaction]] %d\n", AESL_transaction);
  aesl_fh.write(AUTOTB_TVIN_kernal, __xlx_sprintf_buffer.data());
  {
    sc_bv<32> __xlx_tmp_lv = *((int*)&__xlx_apatb_param_kernal);

    sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_lv.to_string(SC_HEX).c_str());
    aesl_fh.write(AUTOTB_TVIN_kernal, __xlx_sprintf_buffer.data()); 
  }
  tcl_file.set_num(1, &tcl_file.kernal_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_kernal, __xlx_sprintf_buffer.data());
}
CodeState = CALL_C_DUT;
Blur_hw_stub_wrapper(__xlx_apatb_param_in_data, __xlx_apatb_param_out_data, __xlx_apatb_param_w, __xlx_apatb_param_h, __xlx_apatb_param_sigma, __xlx_apatb_param_kernal);
