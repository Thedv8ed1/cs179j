...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.Blur.autotvin_in_data_V_data_V.dat"
         "c.Blur.autotvin_in_data_V_keep_V.dat"
         "c.Blur.autotvin_in_data_V_strb_V.dat"
         "c.Blur.autotvin_in_data_V_last_V.dat"
         "c.Blur.autotvin_out_data_V_data_V.dat"
         "c.Blur.autotvin_out_data_V_keep_V.dat"
         "c.Blur.autotvin_out_data_V_strb_V.dat"
         "c.Blur.autotvin_out_data_V_last_V.dat"
         "c.Blur.autotvin_w.dat"
         "c.Blur.autotvin_h.dat"
         "c.Blur.autotvout_out_data_V_data_V.dat"
         "c.Blur.autotvout_out_data_V_keep_V.dat"
         "c.Blur.autotvout_out_data_V_strb_V.dat"
         "c.Blur.autotvout_out_data_V_last_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.Blur.autotvout_out_data_V_data_V.dat"
         "rtl.Blur.autotvout_out_data_V_keep_V.dat"
         "rtl.Blur.autotvout_out_data_V_strb_V.dat"
         "rtl.Blur.autotvout_out_data_V_last_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
