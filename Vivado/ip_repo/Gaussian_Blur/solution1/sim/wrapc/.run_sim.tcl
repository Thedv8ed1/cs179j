...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "Blur.autotvin.dat"
	set constFileTvOut       "Blur.autotvout.dat"
	set constFileHdlTvIn     "Blur.autohdltvin.dat"
	set constFileHdlTvOut    "Blur.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
