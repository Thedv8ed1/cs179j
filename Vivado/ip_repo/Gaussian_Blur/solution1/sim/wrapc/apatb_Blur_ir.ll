; ModuleID = 'C:/PYNQ/PYNQ-master/PYNQ-master/boards/ip/Gaussian_Blur/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_Blur_ir(%"class.hls::stream"* %in_data, %"class.hls::stream"* %out_data, i32 %w, i32 %h, double %sigma, i32 %kernal) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_Blur_hw(%"class.hls::stream"* %in_data_copy, %"class.hls::stream"* %out_data_copy, i32 %w, i32 %h, double %sigma, i32 %kernal)
...
declare void @apatb_Blur_hw(%"class.hls::stream"*, %"class.hls::stream"*, i32, i32, double, i32)

define void @Blur_hw_stub_wrapper(%"class.hls::stream"*, %"class.hls::stream"*, i32, i32, double, i32) #6 {
entry:
  call void @copy_out(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream"* null, %"class.hls::stream"* %1)
  call void @Blur_hw_stub(%"class.hls::stream"* %0, %"class.hls::stream"* %1, i32 %2, i32 %3, double %4, i32 %5)
  call void @copy_in(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream"* null, %"class.hls::stream"* %1)
  ret void
}

declare void @Blur_hw_stub(%"class.hls::stream"*, %"class.hls::stream"*, i32, i32, double, i32)
