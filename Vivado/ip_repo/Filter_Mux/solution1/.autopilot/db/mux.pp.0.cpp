...
# 2 "<built-in>" 2
# 1 "Filter_Mux/mux.cpp" 2

__attribute__((sdx_kernel("Mux", 0))) void Mux(int filter_setting,bool& gray,bool&invert ){
#pragma HLS TOP name=Mux
# 2 "Filter_Mux/mux.cpp"
