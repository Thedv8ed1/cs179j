...
architecture behav of Sobel is 
    ...
    signal Sobel_entry9_U0_ap_start : STD_LOGIC;
    signal Sobel_entry9_U0_start_full_n : STD_LOGIC;
    signal Sobel_entry9_U0_ap_done : STD_LOGIC;
    signal Sobel_entry9_U0_ap_continue : STD_LOGIC;
    signal Sobel_entry9_U0_ap_idle : STD_LOGIC;
    signal Sobel_entry9_U0_ap_ready : STD_LOGIC;
    signal Sobel_entry9_U0_start_out : STD_LOGIC;
    signal Sobel_entry9_U0_start_write : STD_LOGIC;
    signal Sobel_entry9_U0_w_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Sobel_entry9_U0_w_out_write : STD_LOGIC;
    signal Sobel_entry9_U0_w_out1_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Sobel_entry9_U0_w_out1_write : STD_LOGIC;
    signal Sobel_entry9_U0_h_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Sobel_entry9_U0_h_out_write : STD_LOGIC;
    signal Sobel_entry9_U0_h_out2_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Sobel_entry9_U0_h_out2_write : STD_LOGIC;
    signal Block_split32_proc_U0_ap_start : STD_LOGIC;
    signal Block_split32_proc_U0_ap_done : STD_LOGIC;
    signal Block_split32_proc_U0_ap_continue : STD_LOGIC;
    signal Block_split32_proc_U0_ap_idle : STD_LOGIC;
    signal Block_split32_proc_U0_ap_ready : STD_LOGIC;
    signal Block_split32_proc_U0_start_out : STD_LOGIC;
    signal Block_split32_proc_U0_start_write : STD_LOGIC;
    signal Block_split32_proc_U0_w_read : STD_LOGIC;
    signal Block_split32_proc_U0_w_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Block_split32_proc_U0_w_out_write : STD_LOGIC;
    signal Block_split32_proc_U0_vconv_xlim_out_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Block_split32_proc_U0_vconv_xlim_out_out_write : STD_LOGIC;
    ...
    signal Loop_HConvH_proc8_U0_hconv_din : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal Loop_VConvH_proc_U0_vconv_din : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal Loop_Border_proc_U0_out_data_TDATA : STD_LOGIC_VECTOR (7 downto 0);
    signal Loop_Border_proc_U0_out_data_TVALID : STD_LOGIC;
    signal Loop_Border_proc_U0_out_data_TKEEP : STD_LOGIC_VECTOR (0 downto 0);
    signal Loop_Border_proc_U0_out_data_TSTRB : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal w_c37_full_n : STD_LOGIC;
    signal w_c37_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal w_c37_empty_n : STD_LOGIC;
    signal h_c_full_n : STD_LOGIC;
    signal h_c_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal h_c_empty_n : STD_LOGIC;
    signal h_c38_full_n : STD_LOGIC;
    signal h_c38_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal h_c38_empty_n : STD_LOGIC;
    signal w_c39_full_n : STD_LOGIC;
    signal w_c39_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal w_c39_empty_n : STD_LOGIC;
    ...
    signal hconv_dout : STD_LOGIC_VECTOR (7 downto 0);
    signal hconv_empty_n : STD_LOGIC;
    signal vconv_full_n : STD_LOGIC;
    signal vconv_dout : STD_LOGIC_VECTOR (7 downto 0);
    signal vconv_empty_n : STD_LOGIC;
    signal h_c40_full_n : STD_LOGIC;
    signal h_c40_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal h_c40_empty_n : STD_LOGIC;
    signal vconv_xlim_loc_c41_full_n : STD_LOGIC;
    signal vconv_xlim_loc_c41_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal vconv_xlim_loc_c41_empty_n : STD_LOGIC;
    signal start_for_Block_split32_proc_U0_din : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_Block_split32_proc_U0_full_n : STD_LOGIC;
    signal start_for_Block_split32_proc_U0_dout : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_Block_split32_proc_U0_empty_n : STD_LOGIC;
    ...
    component Sobel_Sobel_entry9 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
    ...
    component Sobel_Block_split32_proc IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component Sobel_Loop_HConvH_proc8 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component Sobel_Loop_VConvH_proc IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component Sobel_Loop_Border_proc IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component Sobel_fifo_w32_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component Sobel_fifo_w32_d3_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component Sobel_fifo_w8_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component Sobel_start_for_Block_split32_proc_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component Sobel_start_for_Loop_HConvH_proc8_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component Sobel_start_for_Loop_VConvH_proc_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component Sobel_start_for_Loop_Border_proc_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    ...
    Sobel_entry9_U0 : component Sobel_Sobel_entry9
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    Block_split32_proc_U0 : component Sobel_Block_split32_proc
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    Loop_HConvH_proc8_U0 : component Sobel_Loop_HConvH_proc8
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    Loop_VConvH_proc_U0 : component Sobel_Loop_VConvH_proc
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    Loop_Border_proc_U0 : component Sobel_Loop_Border_proc
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    w_c_U : component Sobel_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
    ...
    w_c37_U : component Sobel_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    h_c_U : component Sobel_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    h_c38_U : component Sobel_fifo_w32_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    w_c39_U : component Sobel_fifo_w32_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    vconv_xlim_loc_c_U : component Sobel_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    hconv_U : component Sobel_fifo_w8_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    vconv_U : component Sobel_fifo_w8_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    h_c40_U : component Sobel_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    vconv_xlim_loc_c41_U : component Sobel_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_Block_split32_proc_U0_U : component Sobel_start_for_Block_split32_proc_U0
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_Loop_HConvH_proc8_U0_U : component Sobel_start_for_Loop_HConvH_proc8_U0
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_Loop_VConvH_proc_U0_U : component Sobel_start_for_Loop_VConvH_proc_U0
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_Loop_Border_proc_U0_U : component Sobel_start_for_Loop_Border_proc_U0
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    Block_split32_proc_U0_ap_continue <= ap_const_logic_1;
    Block_split32_proc_U0_ap_start <= start_for_Block_split32_proc_U0_empty_n;
    ...
    Sobel_entry9_U0_ap_continue <= ap_const_logic_1;
    Sobel_entry9_U0_ap_start <= ap_const_logic_1;
    Sobel_entry9_U0_start_full_n <= (start_for_Loop_VConvH_proc_U0_full_n and start_for_Loop_HConvH_proc8_U0_full_n and start_for_Block_split32_proc_U0_full_n);
    ...
    out_data_TUSER <= Loop_Border_proc_U0_out_data_TUSER;
    out_data_TVALID <= Loop_Border_proc_U0_out_data_TVALID;
    start_for_Block_split32_proc_U0_din <= (0=>ap_const_logic_1, others=>'-');
