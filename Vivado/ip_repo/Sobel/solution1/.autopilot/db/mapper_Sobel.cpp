...
extern "C" void Sobel(__cosim_s7__*, __cosim_s7__*, int, int);
extern "C" void apatb_Sobel_hw(volatile void * __xlx_apatb_param_in_data, volatile void * __xlx_apatb_param_out_data, int __xlx_apatb_param_w, int __xlx_apatb_param_h) {
  ...
  vector<__cosim_s7__> __xlx_in_data_tmp_vec;
  while (!((hls::stream<__cosim_s7__>*)__xlx_apatb_param_in_data)->empty() && __xlx_in_data_V_tmp_Count < __xlx_in_data_V_read_Size) {
    __xlx_in_data_tmp_vec.push_back(((hls::stream<__cosim_s7__>*)__xlx_apatb_param_in_data)->read());
    __xlx_in_data_V_tmp_Count++;
  }
  ap_apatb_in_data_V_cap_bc = __xlx_in_data_tmp_vec.size();
  // store input buffer
  __cosim_s7__* __xlx_in_data_input_buffer= new __cosim_s7__[__xlx_in_data_tmp_vec.size()];
  ...
  __cosim_s7__* __xlx_out_data_input_buffer= new __cosim_s7__[ap_apatb_out_data_V_cap_bc];
  // DUT call
  Sobel(__xlx_in_data_input_buffer, __xlx_out_data_input_buffer, __xlx_apatb_param_w, __xlx_apatb_param_h);
  for (unsigned i = 0; i <ap_apatb_out_data_V_cap_bc; ++i)
    ((hls::stream<__cosim_s7__>*)__xlx_apatb_param_out_data)->write(__xlx_out_data_input_buffer[i]);
}
