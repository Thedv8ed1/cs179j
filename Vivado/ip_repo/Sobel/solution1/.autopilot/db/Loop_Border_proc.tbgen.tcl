...
set C_modelArgList {
	...
	{ vconv int 8 regular {fifo 0 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "h", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "out_data_V_data_V", "interface" : "axis", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
 	{ "Name" : "out_data_V_keep_V", "interface" : "axis", "bitwidth" : 1, "direction" : "WRITEONLY"} , 
 	{ "Name" : "out_data_V_strb_V", "interface" : "axis", "bitwidth" : 1, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "vconv", "interface" : "fifo", "bitwidth" : 8, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ out_data_TDATA sc_out sc_lv 8 signal 3 } 
	{ out_data_TVALID sc_out sc_logic 1 outvld 9 } 
	{ out_data_TREADY sc_in sc_logic 1 outacc 9 } 
	{ out_data_TKEEP sc_out sc_lv 1 signal 4 } 
	{ out_data_TSTRB sc_out sc_lv 1 signal 5 } 
	...
	{ vconv_dout sc_in sc_lv 8 signal 10 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "vconv_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "vconv", "role": "dout" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32ns_32ns_64_2_1_U38", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	vconv { ap_fifo {  { vconv_dout fifo_data 0 8 }  { vconv_empty_n fifo_status 0 1 }  { vconv_read fifo_update 1 1 } } }
}
