...
# FIFO definition:
set ID 58
set FifoName Sobel_fifo_w32_d2_S
set InstName w_c_U
...
# FIFO definition:
set ID 61
set FifoName Sobel_fifo_w32_d3_S
set InstName h_c38_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
# FIFO definition:
set ID 64
set FifoName Sobel_fifo_w8_d2_S
set InstName hconv_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
set ID 67
set FifoName Sobel_fifo_w32_d2_S
set InstName vconv_xlim_loc_c41_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
# FIFO definition:
set ID 68
set FifoName Sobel_start_for_Block_split32_proc_U0
set InstName start_for_Block_split32_proc_U0_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
# FIFO definition:
set ID 69
set FifoName Sobel_start_for_Loop_HConvH_proc8_U0
set InstName start_for_Loop_HConvH_proc8_U0_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
# FIFO definition:
set ID 70
set FifoName Sobel_start_for_Loop_VConvH_proc_U0
...
# FIFO definition:
set ID 71
set FifoName Sobel_start_for_Loop_Border_proc_U0
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { in_data_TDATA { I 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { in_data_TKEEP { I 1 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { in_data_TSTRB { I 1 vector } } \
} "
} else {
