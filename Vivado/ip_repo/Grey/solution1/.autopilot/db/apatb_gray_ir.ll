; ModuleID = 'C:/PYNQ/PYNQ-master/PYNQ-master/boards/ip/Grey/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_gray_ir(%"class.hls::stream"* %in_data, %"class.hls::stream"* %out_data) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_gray_hw(%"class.hls::stream"* %in_data_copy, %"class.hls::stream"* %out_data_copy)
...
declare void @apatb_gray_hw(%"class.hls::stream"*, %"class.hls::stream"*)

define void @gray_hw_stub_wrapper(%"class.hls::stream"*, %"class.hls::stream"*) #6 {
entry:
  call void @copy_out(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream"* null, %"class.hls::stream"* %1)
  call void @gray_hw_stub(%"class.hls::stream"* %0, %"class.hls::stream"* %1)
  call void @copy_in(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream"* null, %"class.hls::stream"* %1)
  ret void
}

declare void @gray_hw_stub(%"class.hls::stream"*, %"class.hls::stream"*)
